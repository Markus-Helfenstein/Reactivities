...
namespace Application.Core
{
    public class MappingProfiles : Profile
    {
        ...
        {
            string currentNormalizedUserName = null;
            ...
            CreateMap<ActivityAttendee, AttendeeDto>()
                ...
                .ForMember(target => target.IsCurrentUserFollowing, opt => opt.MapFrom(source => 
                    source.AppUser.Followers.Any(uf => uf.Observer.NormalizedUserName == currentNormalizedUserName)));
            ...
            CreateMap<AppUser, Profiles.Profile>()
                ...
                .ForMember(target => target.IsCurrentUserFollowing, opt => opt.MapFrom(source => 
                    source.Followers.Any(uf => uf.Observer.NormalizedUserName == currentNormalizedUserName)));
